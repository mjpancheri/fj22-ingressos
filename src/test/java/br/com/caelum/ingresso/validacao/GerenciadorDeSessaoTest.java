...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroHorarioDeUmaSessaoExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.parse("10:00:00");
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroHorarioDeUmaSessaoExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.parse("10:00:00");
